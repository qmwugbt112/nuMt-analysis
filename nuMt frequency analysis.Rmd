...
log$(p_{obs})$ ~ SNP + log$(c+m)$ + log$(c+m)$:SNP + (1 | individual), and plotting a histogram of the slopes.
...
# find the SNP:xval interaction terms in mod6
...
The rogue SNPs do not follow the expected 1:1 relationship with $(c+m)$
